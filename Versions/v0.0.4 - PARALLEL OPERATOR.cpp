...
class wallOfText //stores all big lines of text and instructions, including any menus
{
    ...
    public:
        ...
        {
            ClearScreen();
            cout << "--------------------------Welcome the CONSOLE calculator--------------------------" << endl;
            cout << "a. Console"<<endl;
        ...
        void instructions()
        {
            cout<<">Greetings! Welcome to the CONSOLE Calculator, here are the basics of the menus"<<endl;
            ...
            cout<<"> The | operator calculates the parallel resistance"<<endl;
            char a;
            cin>>a;
            if(a == 'q')
            {
